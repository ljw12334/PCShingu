	...
	<div class="bottom-area">
		...
		try (
			...
			if (rs.next()) {
				...
				clockDef = rs.getFloat("clock_def");
				clockMax = rs.getFloat("clock_max");
				core = rs.getInt("core");
				thread = rs.getInt("thread");
				builtInGraphics = rs.getString("built_in_graphics");
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					...
					<div class="input-content">
						<select name="manufacturer" class="short">
						<%
						if (manufacturer.equals("Intel")) {
						%>
				...
				<div class="input-area">
					<div class="input-name">세대</div>
					<div class="input-content">
						<input type="text" name="gen" class="middle" value="<%=gen%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">라인</div>
					<div class="input-content">
						<input type="text" name="modifier" class="middle" value="<%=modifier%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">소켓</div>
					<div class="input-content">
						<input type="text" name="socket" class="middle" value="<%=socket%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">기본 클럭</div>
					<div class="input-content">
						<input type="number" step="0.01" name="clock-def" class="short" value="<%=clockDef%>"> GHz
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">최대 클럭</div>
					<div class="input-content">
						<input type="number" step="0.01" name="clock-max" class="short" value="<%=clockMax%>"> GHz
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">코어 수</div>
					<div class="input-content">
						<input type="number" name="core" class="short" value="<%=core%>"> Big + Little
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">쓰레드 수</div>
					<div class="input-content">
						<input type="number" name="thread" class="short" value="<%=thread%>"> Big + Little
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">내장그래픽</div>
					<div class="input-content">
						<%
						if (builtInGraphics.equals("탑재")) {
						%>
							<input type="radio" name="built-in-graphics" value="탑재" checked="checked">탑재
							<input type="radio" name="built-in-graphics" value="미탑재">미탑재
						<%
						} else if (builtInGraphics.equals("미탑재")) {
						%>
							<input type="radio" name="built-in-graphics" value="탑재">탑재
							<input type="radio" name="built-in-graphics" value="미탑재" checked="checked">미탑재
						<%
						} else {
						%>
							<input type="radio" name="built-in-graphics" value="탑재" checked="checked">탑재
