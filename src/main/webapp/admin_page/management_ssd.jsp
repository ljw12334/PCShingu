	...
	<div class="bottom-area">
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					<div class="input-name">종류</div>
					<div class="input-content">
						<select name="kind" class="middle">
						<%
						if (kind.equals("M.2")) {
						%>
				...
				<div class="input-area">
					<div class="input-name">용량</div>
					<div class="input-content">
						<input type="number" name="size" class="short" value="<%=size%>"> GB
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">DRAM</div>
					<div class="input-content">
						<%
						if (dram.equals("탑재")) {
						%>
							<input type="radio" name="dram" value="탑재" checked="checked">탑재
							<input type="radio" name="dram" value="미탑재">미탑재
						<%
						} else if (dram.equals("미탑재")) {
						%>
							<input type="radio" name="dram" value="탑재">탑재
							<input type="radio" name="dram" value="미탑재" checked="checked">미탑재
						<%
						} else {
						%>
							<input type="radio" name="dram" value="탑재" checked="checked">탑재
