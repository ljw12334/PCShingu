	...
	<div class="bottom-area">
		...
		try (
			...
			if (rs.next()) {
				...
				heatsink = rs.getString("heatsink");
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					...
					<div class="input-content">
						<input type="text" name="kind" class="short" value="<%=kind%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">메모리 클럭</div>
					<div class="input-content">
						<input type="number" name="clock" class="short" value="<%=clock%>"> MHz
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">히트싱크</div>
					<div class="input-content">
						<%
						if (heatsink.equals("탑재")) {
						%>
							<input type="radio" name="heatsink" value="탑재" checked="checked">탑재
							<input type="radio" name="heatsink" value="미탑재">미탑재
						<%
						} else if (heatsink.equals("미탑재")) {
						%>
							<input type="radio" name="heatsink" value="탑재">탑재
							<input type="radio" name="heatsink" value="미탑재" checked="checked">미탑재
						<%
						} else {
						%>
							<input type="radio" name="heatsink" value="탑재" checked="checked">탑재
