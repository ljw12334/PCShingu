	...
	<div class="bottom-area">
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					<div class="input-name">케이블 형태</div>
					<div class="input-content">
						<select name="cable" class="middle">
						<%
						if (cable.equals("풀모듈러")) {
						%>
							<option value="풀모듈러" selected>풀모듈러</option>
							<option value="세미모듈러">세미모듈러</option>
							<option value="케이블일체형">케이블일체형</option>
						<%
						} else if (cable.equals("세미모듈러")) {
						%>
							<option value="풀모듈러">풀모듈러</option>
							<option value="세미모듈러" selected>세미모듈러</option>
							<option value="케이블일체형">케이블일체형</option>
						<%
						} else if (cable.equals("케이블일체형")) {
						%>
							<option value="풀모듈러">풀모듈러</option>
							<option value="세미모듈러">세미모듈러</option>
							<option value="케이블일체형" selected>케이블일체형</option>
						<%
						} else {
						%>
							<option value="풀모듈러" selected>풀모듈러</option>
