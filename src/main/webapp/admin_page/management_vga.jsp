	...
	<div class="bottom-area">
		...
		try (
			...
			if (rs.next()) {
				...
				vram = Integer.parseInt(rs.getString("vram"));
				hdmi = Integer.parseInt(rs.getString("hdmi"));
				dp = Integer.parseInt(rs.getString("dp"));
				rgb = Integer.parseInt(rs.getString("rgb"));
				dvi = Integer.parseInt(rs.getString("dvi"));
				fanCount = Integer.parseInt(rs.getString("fan_count"));
				length = Integer.parseInt(rs.getString("length"));
				backplate = rs.getString("backplate");
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					<div class="input-name">계열</div>
					<div class="input-content">
						<select name="kind" class="short">
						<%
				...
				<div class="input-area">
					<div class="input-name">칩셋</div>
					<div class="input-content">
						<input type="text" name="chipset" class="middle" value="<%=chipset%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">VRAM</div>
					<div class="input-content">
						<input type="number" name="vram" class="short" value="<%=vram%>"> GB
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">HDMI 포트</div>
					<div class="input-content">
						<input type="number" name="hdmi" class="short" value="<%=hdmi%>"> 개
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">DP 포트</div>
					<div class="input-content">
						<input type="number" name="dp" class="short" value="<%=dp%>"> 개
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">RGB 포트</div>
					<div class="input-content">
						<input type="number" name="rgb" class="short" value="<%=rgb%>"> 개
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">DVI 포트</div>
					<div class="input-content">
						<input type="number" name="dvi" class="short" value="<%=dvi%>"> 개
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">팬 개수</div>
					<div class="input-content">
						<input type="number" name="fan-count" class="short" value="<%=fanCount%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">길이</div>
					<div class="input-content">
						<input type="number" name="length" class="short" value="<%=length%>"> mm
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">백플레이트</div>
					<div class="input-content">
						<%
						if (backplate.equals("탑재")) {
						%>
							<input type="radio" name="backplate" value="탑재" checked="checked">탑재
							<input type="radio" name="backplate" value="미탑재">미탑재
						<%
						} else if (backplate.equals("미탑재")) {
						%>
							<input type="radio" name="backplate" value="탑재">탑재
							<input type="radio" name="backplate" value="미탑재" checked="checked">미탑재
						<%
						} else {
						%>
							<input type="radio" name="backplate" value="탑재" checked="checked">탑재
				...
				<div class="input-area">
					<div class="input-name">권장파워용량</div>
					<div class="input-content">
						<input type="number" name="power" class="short" value="<%=power%>"> W
					</div>
				</div>
				<br>
				<hr>
					...
					do {
						...
						<div class="list-product-area">
							...
							<div class="list-product-bt-recommend">
								<a href="db_recommend/recommend.jsp?name=<%=rs.getString("name")%>&pdt_kind=<%=pdtKind%>"
