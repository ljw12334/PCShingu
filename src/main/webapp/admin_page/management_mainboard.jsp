	...
	<div class="bottom-area">
		...
		try (
			...
			if (rs.next()) {
				...
				memoryKind = rs.getString("memory_kind");
				memoryCount = rs.getInt("memory_count");
				sataCount = rs.getInt("sata_count");
				m2Count = rs.getInt("m2_count");
				cpumf = rs.getString("cpumf");
		...
		%>
			<form action="db_update/update_<%= pdtKind %>.jsp" enctype="multipart/form-data" method="post">
				...
				<div class="input-area">
					<div class="input-name">소켓 제조사</div>
					<div class="input-content">
						<select name="cpumf" class="short">
						<%
						if (cpumf.equals("Intel")) {
						%>
							<option value="Intel" selected>Intel</option>
							<option value="AMD">AMD</option>
						<%
						} else if (cpumf.equals("AMD")) {
						%>
				...
				<div class="input-area">
					<div class="input-name">규격</div>
					<div class="input-content">
						<input type="text" name="standard" class="middle" value="<%=standard%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">메모리 종류</div>
					<div class="input-content">
						<input type="text" name="memory-kind" class="short" value="<%=memoryKind%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">메모리 개수</div>
					<div class="input-content">
						<input type="number" name="memory-count" class="short" value="<%=memoryCount%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">SATA 슬롯 개수</div>
					<div class="input-content">
						<input type="number" name="sata-count" class="short" value="<%=sataCount%>">
					</div>
				</div>
				<div class="input-area">
					<div class="input-name">M.2 슬롯 개수</div>
					<div class="input-content">
						<input type="number" name="m2-count" class="short" value="<%=m2Count%>">
					</div>
				</div>
				<br>
				<hr>
						...
						<div class="list-product-area">
							...
							<div class="list-product-bt-delete">
								<a href="db_delete/delete_product.jsp?name=<%=rs.getString("name")%>&kind=<%= pdtKind %>"
									...
									<input type="button" class="bt-submit" value="삭제">
								</a>
							</div>
						</div>
						<%
